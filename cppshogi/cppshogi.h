...
constexpr u32 MAX_PIECES_IN_HAND_SUM = MAX_HPAWN_NUM + MAX_HLANCE_NUM + MAX_HKNIGHT_NUM + MAX_HSILVER_NUM + MAX_HGOLD_NUM + MAX_HBISHOP_NUM + MAX_HROOK_NUM; // 4+3+3+3+3+2+2 = 20
constexpr u32 LOG_MAX_PIECES_IN_HAND_SUM = LOG_MAX_HPAWN_NUM + LOG_MAX_HLANCE_NUM + LOG_MAX_HKNIGHT_NUM + LOG_MAX_HSILVER_NUM + LOG_MAX_HGOLD_NUM + LOG_MAX_HBISHOP_NUM + LOG_MAX_HROOK_NUM; // 1+1+1+1+1+1+1=7
...
constexpr u32 MAX_FEATURES1_NUM = PIECETYPE_NUM; // 駒の配置のみ
constexpr u32 MAX_FEATURES2_NUM = MAX_FEATURES2_HAND_NUM
#ifdef NYUGYOKU_FEATURES
...
void make_input_features(const Position& position, packed_features1_t packed_features1, features2_t packed_features2);
