		...
		if (token == "quit") {
			...
			if (!initialized) {
				...
				const std::string model_paths[max_gpu] = {
					options["DNN_Model"], options["DNN_Model2"], options["DNN_Model3"], options["DNN_Model4"], options["DNN_Model5"], options["DNN_Model6"], options["DNN_Model7"], options["DNN_Model8"],
					options["DNN_Mode9"], options["DNN_Model10"], options["DNN_Model11"], options["DNN_Model12"], options["DNN_Model13"], options["DNN_Model14"], options["DNN_Model15"], options["DNN_Model16"]
				};
				// モデルファイル存在チェック
				{
					bool is_err = false;
				...
				const int new_thread[max_gpu] = {
					options["UCT_Threads"], options["UCT_Threads2"], options["UCT_Threads3"], options["UCT_Threads4"], options["UCT_Threads5"], options["UCT_Threads6"], options["UCT_Threads7"], options["UCT_Threads8"],
					options["UCT_Threads9"], options["UCT_Threads10"], options["UCT_Threads11"], options["UCT_Threads12"], options["UCT_Threads13"], options["UCT_Threads14"], options["UCT_Threads15"], options["UCT_Threads16"] 
				};
				const int new_policy_value_batch_maxsize[max_gpu] = {
					options["DNN_Batch_Size"], options["DNN_Batch_Size2"], options["DNN_Batch_Size3"], options["DNN_Batch_Size4"], options["DNN_Batch_Size5"], options["DNN_Batch_Size6"], options["DNN_Batch_Size7"], options["DNN_Batch_Size8"],
					options["DNN_Batch_Size9"], options["DNN_Batch_Size10"], options["DNN_Batch_Size11"], options["DNN_Batch_Size12"], options["DNN_Batch_Size13"], options["DNN_Batch_Size14"], options["DNN_Batch_Size15"], options["DNN_Batch_Size16"],
				};
