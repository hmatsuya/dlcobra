"""Isotropic InceptionNeXt with torch.compile and channels_last optimization.

depths=[10], dims=[192]

Based on exp015 but with:
- torch.channels_last memory format for native NHWC processing
- torch.compile for kernel fusion and optimization
- Eliminates permute overhead in LayerNorm operations

Expected: 2-3x inference speedup with zero accuracy loss.
"""
import torch
