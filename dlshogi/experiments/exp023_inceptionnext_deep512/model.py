"""InceptionNeXt (depths=[40], dims=[512]) + 1 plain self-attention tail block.

Based on exp022 (depths=[10], dims=[192]).
Scaled up: 39 InceptionNeXt blocks + 1 plain attention block.
"""
import torch
