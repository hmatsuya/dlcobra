...
# Usage: bash dlshogi/experiments/exp033_flip_aug_from_scratch/resume.sh [extra args...]
...
# Resolve the WandB run ID for this experiment.
# run.sh saves it to wandb_run_id after each run; fall back to mtime scan if missing.
