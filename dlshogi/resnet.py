...
class ResNet(nn.Module):
    ...
    def _make_layer(self, block: Type[Union[BasicBlock, Bottleneck, BasicBlockDropout]], planes: int, blocks: int,
                    stride: int = 1, dilate: bool = False, activation: Callable = nn.ReLU(inplace=True)) -> nn.Sequential:
