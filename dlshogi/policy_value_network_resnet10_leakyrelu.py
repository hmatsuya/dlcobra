...
class PolicyValueNetwork(ResNet):
    def __init__(self, use_aux=False):
        ...
        self.inplanes = k
        self.l2 = self._make_layer(BasicBlock, k, 10, activation=nn.LeakyReLU(inplace=True))
        # policy network
    ...
    def __call__(self, x1, x2):
        ...
        # value network
        h22_v = self.activation(self.norm22_v(self.l22_v(u2)))
